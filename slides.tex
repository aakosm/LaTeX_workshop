...
\frametitle{adding figures and tables - input}
	...
	\begin{figure}[h!]
	\includegraphics[scale=0.5]{ceu_picture.jpg} % the [scale=0.5] parameter will scale the image
	\caption{A picture of CEU}
	\label{fig:ceu}
	\end{figure}
	\bigskip

	% tables are hard. Proof:
    ...
    \begin{tabular}{*4c}
        ...
        \bottomrule
    \end{tabular}
    \caption{\tiny MWE of a table using booktabs \\ Source: https://tex.stackexchange.com/questions/238503/tip-on-how-to-make-a-visually-good-table}
    \label{tab:booktabs}
    \end{table}
	\end{minted}
...
\begin{frame}
\frametitle{Due to the limits of Beamer and my patience, cue} \pause
	the mwe.tex (for some reason that I could not figure out, Beamer acts funny with the previous slide's table and paragraph formatting) \\ \pause
	\\
	\textbf{MWE: Minimal Working Example}: \\
	for a reason and guide to creating MWEs see here: https://tex.meta.stackexchange.com/a/3225
\end{frame}

\begin{frame}
\frametitle{LaTeX is not a hammer and building tables is not a nail} \pause
...
There are StackOverflow and Sharelatex tutorials.
\end{frame}
...
\item Whatever figures or pictures you want to include
\end{itemize}
\end{frame}

\begin{frame}
\centering
\includegraphics[scale=0.4]{dissertation_files.png}

\end{frame}

\begin{frame}
Some of the advice is outdated in the CEU template if you use ShareLatex or TeXstudio or other contemporary editor:
...
\frametitle{Using LaTeX for CVs, or presentations}
	You can find plenty of great LaTeX CV templates on ShareLatex which you can modify after.
	\medskip
...
\begin{frame}[t]\frametitle{Some good examples}
    Some good examples of what LaTeX can do for your dissertation you can check out some that looks great (no judgment on the content):
    \begin{itemize}
    	\item \href{https://goo.gl/4sa1rc}{Bastian Becker's}
    	\item \href{https://goo.gl/7FuJfp}{Zbigniew Truchlewski's}
    \end{itemize}
